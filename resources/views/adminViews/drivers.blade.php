				...
				<table class="min-w-full divide-y divide-gray-200 box-border">
			          ...
			          <tbody class="bg-white divide-y divide-gray-200">				  
			            ...
			            <tr>
			              ...
			              <td class="px-6 py-4 whitespace-nowrap">
			                <div class="text-sm text-gray-900 driver_name">Maria Mbugua</div>
			              </td>
			              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 driver_phone_number">+254 705 999 817</td>
			              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 driver_licence">WL9899</td>
			              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
			                <button onclick="editModal()" class="text-gray-800 hover:underline bg-blue-100 px-3 py-1 rounded">Edit</button>
							<button onClick="deleteDriver()" class="text-gray-800 hover:underline bg-red-100 px-3 py-1 rounded">Delete</button>
			              </td>
			            </tr>
			            <!-- More people... -->
			          </tbody>
